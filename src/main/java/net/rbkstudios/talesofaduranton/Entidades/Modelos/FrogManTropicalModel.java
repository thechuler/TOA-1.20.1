...
public class FrogManTropicalModel<T extends FrogManTropicalEntity> extends HierarchicalModel<T> {
	...
	public FrogManTropicalModel(ModelPart root) {
	...
	public void setupAnim(T t, float v, float v1, float v2, float v3, float v4) {
		...
		this.animateWalk(FrogManTropicalAnimaciones.CAMINAR, v, v1, 4f, 2.5f);
		this.animate(((FrogManTropicalEntity) t).idleAnimationState, FrogManTropicalAnimaciones.IDLE, v2, 1f);
		this.animate(((FrogManTropicalEntity) t).gruñirAnimationState, FrogManTropicalAnimaciones.GRUÑIDO, v2, 1f);
		this.animate(((FrogManTropicalEntity) t).climbAnimationState, FrogManTropicalAnimaciones.CLIMB, v2, 1f);
	}
